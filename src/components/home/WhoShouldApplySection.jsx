...
const ImagePlaceholder = ({ name }) => (
  <div className="p-3">
    <div className="h-40 md:h-48 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg border border-gray-700 flex items-center justify-center">
      <div className="text-center">
        <svg className="w-14 h-14 mx-auto mb-2 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-20 pt-6 md:pt-12 flex-1 flex flex-col pb-4">
        ...
        <div className="md:hidden flex flex-col flex-1">
          ...
          <div className="flex-1 p-3">
            <div className="h-full rounded-lg overflow-hidden border border-gray-700 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
