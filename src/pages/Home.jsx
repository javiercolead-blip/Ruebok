...
function Home() {
  ...
  return (
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      {/* Background Decorative Elements - Transparent */}
      {/* Capital Raised Graph - Background */}
      <div className="absolute bottom-16 left-20 w-[400px] opacity-[0.08] pointer-events-none z-0" style={{ animation: 'slow-bounce 15s ease-in-out infinite', animationDelay: '2s' }}>
      ...
      {/* Criteria Diagram - Background */}
      <div className="absolute bottom-[400px] right-[-100px] w-[900px] opacity-[0.08] pointer-events-none z-0" style={{ animation: 'slow-bounce 15s ease-in-out infinite' }}>
        <img src="/criteria.png" alt="" className="w-full h-auto" />
      </div>
